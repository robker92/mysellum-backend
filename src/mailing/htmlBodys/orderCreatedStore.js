...
const subjectOrderCreatedStore = 'Order Received';

const attachmentsOrderCreatedStore = [
    mysellumAtt,
    facebookAtt,
    instagramAtt,
    linkedinAtt,
...
function getContentOrderCreatedStore2(options) {
                                        ...
                                        <div class="col_cont" style="width:100% !important;">
                                            ...
                                            <div
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td align="center"
                                                            ...
                                                            <h1
                                                                ...
                                                                <strong>Order Received</strong></h1>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 20px;">congratulations! Your store did receive a new order. You can view it here using the link below.</span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                ...
                                                <div align="center" class="button-container"
                                                    ...
                                                    <a
                                                        href="${FRONTEND_BASE_URL}/store-order-overview/${options.storeId}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 12px;">If you have any further questions, please feel free to</span><br /><span
                                                                style="font-size: 12px;"> contact us
