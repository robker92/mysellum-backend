...
// console.log(`dirname in body function: ${__dirname}`);
const attachmentsPasswordReset = [
    mysellumAtt,
    facebookAtt,
    instagramAtt,
    linkedinAtt,
                                                        ...
                                                        <tr style="vertical-align: top;" valign="top">
                                                            <td align="center"
                                                                ...
                                                                <h1
                                                                    ...
                                                                    <strong>Password Reset</strong></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="txtTinyMce-wrapper"
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 20px;">If you have lost your password or wish to reset it, please use the link below to get started.</span></p>
                                                        </div>
                                                    </div>
                                                    <!--[if mso]></td></tr></table><![endif]-->
                                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                            ...
                                                            target="_blank"><span
                                                                style="padding-left:25px;padding-right:25px;font-size:18px;display:inline-block;letter-spacing:undefined;"><span
                                                                    style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                        ...
                                                                        style="font-size: 18px; line-height: 36px;">Reset Your
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="txtTinyMce-wrapper"
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">If you did not request a password reset, you can safely ignore this email. Only a person with access to your email can reset your account's password.
                                                                    </span></p>
                                                        </div>
                                                    </div>
                                                    <!--[if mso]></td></tr></table><![endif]-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="txtTinyMce-wrapper"
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 12px;">This link will expire in 24
                                                                    hours. If you continue to have problems</span><br /><span
