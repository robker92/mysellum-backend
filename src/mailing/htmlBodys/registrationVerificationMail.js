...
const subjectRegVerification = 'Email Verification';

const attachmentsRegVerification = [
    mysellumAtt,
    facebookAtt,
    instagramAtt,
    linkedinAtt,
...
function getContentRegVerification2(verificationToken) {
    let htmlBody = `<b>Hello User</b><br/> <br/> 

    Please follow this link to verify your e-mail address: <a href="${FRONTEND_BASE_URL}/registration-verification/${verificationToken}">Verify your E-Mail</a>`;
    return htmlBody;
}

function getContentRegVerification(options) {
    let htmlBody = `
    <!DOCTYPE html
                                        ...
                                        <div class="col_cont" style="width:100% !important;">
                                            ...
                                            <div
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td align="center"
                                                            ...
                                                            <h1
                                                                ...
                                                                <strong>Registration Verification</strong></h1>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 20px;">we want to welcome you on board of Mysellum! Please verify your email address using the link below.</span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                                ...
                                                <div align="center" class="button-container"
                                                    ...
                                                    <a
                                                        href="${FRONTEND_BASE_URL}/registration-verification/${options.verificationToken}"
                                                        ...
                                                        target="_blank"><span
                                                            style="padding-left:25px;padding-right:25px;font-size:18px;display:inline-block;letter-spacing:undefined;"><span
                                                                style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                    ...
                                                                    style="font-size: 18px; line-height: 36px;">Verify Your Email</span></span></span></a>
                                                ...
                                                <div
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 12px;">This link will expire in 7
                                                                days. If you can not verify your email in time</span><br /><span
                                                                style="font-size: 12px;">please feel free to contact us
