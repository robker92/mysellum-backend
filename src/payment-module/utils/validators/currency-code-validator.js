 ...
 * @param {string} currencyCodeToValidate e.g. "EUR"
 * @throws an error if an invalid code has been provided
 */
function validateCurrencyCode(currencyCodeToValidate) {
    ...
    if (!currencyCodeArray.includes(currencyCodeToValidate)) {
        throw new Error(`The provided currencyCode ${currencyCodeToValidate} is not among the allowed values.`);
    }
